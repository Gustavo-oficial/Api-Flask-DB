...
def criar_carro():
    ...
    try:
        carro = Carros(id=body["id"], nome=body["nome"], modelo=body["modelo"], valor=body["valor"], cor=body["cor"], numero_Vendas=body["numero_Vendas"], ano=body["ano"])

        mybd.session.add(carro)
        mybd.session.commit()
        
        return gera_response(200, "carros", carro.to_json(), "Criado com Sucesso!!!")
...
def atualizar_carro(id):
    ...
    try:
        ...
        return gera_response(200, "carros", carro_objetos.to_json(), "Carro atualizado com Sucesso!!!")

    except Exception as e:
        print('Erro', e)
        
        return gera_response(400, "carros", {}, "Erro ao editar carro!!")   
...
def deletar_carro(id):
    ...
    try:
        ...
        return gera_response(200, "carros", carro_objetos.to_json(), "Carro deletado com Sucesso!!!")
    
    except Exception as e:
        print('Erro', e)
        
        return gera_response(400, "carros", {}, "Erro ao deletar carro!!")
